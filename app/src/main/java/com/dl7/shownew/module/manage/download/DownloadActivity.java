package com.dl7.shownew.module.manage.download;
...
import com.dl7.shownew.injector.components.DaggerDownloadComponent;
import com.dl7.shownew.injector.modules.DownloadModule;
import com.dl7.shownew.module.base.BaseActivity;
import com.dl7.shownew.module.base.BaseVideoDLFragment;
...
import com.dl7.shownew.rxbus.event.VideoEvent;
import com.dl7.shownew.utils.CommonConstant;

import com.dl7.shownew.widget.FlexibleViewPager;
...
public class DownloadActivity extends BaseActivity<IRxBusPresenter> {
    ...
    Toolbar mToolBar;
    @BindView(R.id.tab_layout) SlidingTabLayout mTabLayout;
    @BindView(R.id.view_pager) FlexibleViewPager mViewPager;
    ...
    @Inject ViewPagerAdapter mPagerAdapter;
