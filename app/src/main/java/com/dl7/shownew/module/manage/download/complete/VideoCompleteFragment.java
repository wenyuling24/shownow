package com.dl7.shownew.module.manage.download.complete;
...
import com.dl7.shownew.injector.components.DaggerVideoCompleteComponent;
 ...
 * video 缓存完成列表
 */
public class VideoCompleteFragment extends BaseVideoDLFragment<IRxBusPresenter>
