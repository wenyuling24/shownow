...
import com.dl7.shownew.api.NewsUtils;
import com.dl7.shownew.api.bean.NewsDetailInfo;
import com.dl7.shownew.injector.components.DaggerNewsArticleComponent;
import com.dl7.shownew.injector.modules.NewsArticleModule;
import com.dl7.shownew.module.base.BaseSwipeBackActivity;
...
import com.dl7.shownew.utils.ListUtils;
import com.dl7.shownew.utils.PreferencesUtils;
import com.dl7.shownew.widget.EmptyLayout;
import com.dl7.shownew.widget.PullScrollView;
...
public class NewsArticleActivity extends BaseSwipeBackActivity<IBasePresenter> implements INewsArticleView {
    ...
    @BindView(R.id.scroll_view) PullScrollView mScrollView;
    @BindView(R.id.empty_layout) EmptyLayout mEmptyLayout;
