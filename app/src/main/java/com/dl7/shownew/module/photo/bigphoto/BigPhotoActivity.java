package com.dl7.shownew.module.photo.bigphoto;
...
import com.dl7.shownew.adapter.PhotoPagerAdapter;
import com.dl7.shownew.injector.components.DaggerBigPhotoComponent;
...
import com.dl7.shownew.utils.AnimateHelper;
import com.dl7.shownew.utils.CommonConstant;
import com.dl7.shownew.utils.DownloadUtils;
import com.dl7.shownew.utils.NavUtils;
import com.dl7.shownew.utils.SnackbarUtils;
import com.dl7.shownew.utils.ToastUtils;
import com.dl7.shownew.widget.PhotoViewPager;
 ...
 */
public class BigPhotoActivity extends BaseActivity<ILocalPresenter>
    implements ILoadDataView<List<BeautyPhotoInfo>> {
    ...
    @BindView(R.id.vp_photo) PhotoViewPager mVpPhoto;
    ...
    Toolbar mToolbar;
    @BindView(R.id.drag_layout) DragSlopLayout mDragLayout;
    @BindView(R.id.ll_layout)
    LinearLayout mLlLayout;

    @Inject PhotoPagerAdapter mAdapter;
...
//        mAdapter = new PhotoPagerAdapter(this);
    ...
    @OnClick({R.id.iv_favorite, R.id.iv_praise, R.id.iv_share, R.id.iv_download})
