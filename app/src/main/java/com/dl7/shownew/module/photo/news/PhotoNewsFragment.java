package com.dl7.shownew.module.photo.news;
...
import com.dl7.shownew.injector.components.DaggerPhotoNewsComponent;
 ...
 * 图片新闻列表
 */
public class PhotoNewsFragment extends BaseFragment<IBasePresenter>
    implements ILoadDataView<List<PhotoInfo>> {
