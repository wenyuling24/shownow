package com.dl7.shownew.module.video.list;
...
import com.dl7.shownew.injector.components.DaggerVideoListComponent;
 ...
 */
public class VideoListFragment extends BaseFragment<IBasePresenter>
    implements ILoadDataView<List<VideoInfo>> {
