...
import com.dl7.shownew.engine.danmaku.DanmakuConverter;
import com.dl7.shownew.engine.danmaku.DanmakuLoader;
import com.dl7.shownew.engine.danmaku.DanmakuParser;
import com.dl7.shownew.injector.components.DaggerVideoPlayerComponent;
...
import com.dl7.shownew.widget.SimpleButton;
...
public class VideoPlayerActivity extends BaseActivity<IVideoPresenter> implements IVideoView {
    ...
    protected void initInjector() {
        mVideoData = getIntent().getParcelableExtra(CommonConstant.VIDEO_DATA_KEY);
    ...
    protected void initViews() {
        ...
        mPlayerView.init()
                ...
                .enableDanmaku()
                .setDanmakuCustomParser(new DanmakuParser(), DanmakuLoader.instance(), DanmakuConverter
                    .instance())
